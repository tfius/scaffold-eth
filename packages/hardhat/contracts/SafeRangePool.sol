...
// how to: https://ohmzeus.gitbook.io/range/how-to-swap
// write
// approve (spender, amount)
// swap (firstTokenAddress, amount, secondTokenAddress) // USDC/USDT
// LP There are two options for adding liquidity. You can add with a single token or all tokens.
// *********************************************************************************************
// add (tokenAddress, amount)
// addAll(amount)
// remove (tokenAddress, amount)
// removeAll(amount)
// View Functions - Fees accrue to LPs with a rising redemption value per pool token
// fee()
// redemptionValue()
// value(amount)  **** token value => pool token value

// ********************************************************************************************* 
// Maximum amount of token that can be added, removed, or swapped (from one to another).
// maxCanAdd( address token )
// maxCanRemove( address token )

// maxCanSwap( firstTokenAddress, secondTokenAddress )
// amountOut( firstTokenAddress,  amount,  secondTokenAddress )

// ********************************************************************************************* 
// Ownable Functions - The owner can add tokens, change bounds, change the pool fee, and pause deposits of an asset.
// addToken( tokenAddress, uint lowAP, uint highAP ) 
// changeBound( tokenAddress, uint newLow, uint newHigh )
// toggleAccept( tokenAddress )
// setFee( uint newFee, collectorAddress, collectTokenAddress ) 
 ...
 */
contract SafeRangePool is ERC20, Ownable {
