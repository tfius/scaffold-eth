...
contract Exchange is SignatureValidator, ReentrancyGuard, Ownable, EIP712Order {
   ...
   */
  function swap(Order calldata _order, bytes calldata _signature) external payable nonReentrant returns (bool) {
    // Must not be expired
