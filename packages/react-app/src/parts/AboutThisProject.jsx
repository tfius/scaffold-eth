  ...
  return (
    ...
    >
      ...
      <Card title="Setup wallet">
        You will need MetaMask to mint one of our FDS Resistance NFTs. Install the chrome extension or download the
        mobile app to get started. Please reference this article to learn how to set up MetaMask. If you are curious,
        other wallet options can be found here.
      </Card>

      <Card title="Buy">
        Our FDS Resistance NFT will be free, but you will need to pay a small transaction fee (referred to as “gas”) to
        the {chain} network to mint the NFT. You can directly deposit to your MetaMask wallet or use a popular exchange
        or a service to acquire a small amount of {symbol}. Typically 0.1 {symbol} will be more than sufficient for gas,
        but gas can vary depending on how busy the network is.
      </Card>
      ...
      <Card title="FAQ">
        <ul>
          ...
          Mainnet New RPC URL: <strong>https://dai.poa.network</strong>
          <br />
          Chain ID: <strong>100</strong>
          <br />
          Currency Symbol: <strong>XDAI</strong>
          <br />
          Block Explorer URL: <strong>https://goerli.etherscan.io/</strong>
          <br />
          <li>Faucet</li>
          {/* <href to="https://goerli-faucet.slock.it/" >https://goerli-faucet.slock.it/</href> <br/>  */}
          ...
          If you would like to sell or trade your FDS Resistance NFT, you can list the token on secondary markets or
