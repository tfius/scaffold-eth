...
export class FormGatherProduction extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>
        ...
        >
          ...
          {this.state.file != null && (
            <>
              ...
              <Button
                type=""
                onClick={e => {
                  this.props.onVerifyProduction(this.props.request.reviewRequest.candidate, this.state.hash, true);
                }}
              >
                Approve Production
              </Button>
          ...
          {this.props.request.checkValidationProcedure.production == true && (
            <>
              <Button
                type=""
                onClick={e => {
                  this.props.onVerifyProduction(
...
export default FormGatherProduction;
