...
export const categoriesTree = [
...

  {
    ...
    items: [
      ...
      { label: "Basics", items: [{ label: "Reading" }, { label: "Writing" }, { label: "Math" }] },
      {
        label: "Teaching",
        items: [
      ...
      {
        label: "Economics",
        items: [{ label: "Economics" }, { label: "Finance" }, { label: "Accounting" }, { label: "Business" }],
      },
      {
        label: "Art",
        items: [
